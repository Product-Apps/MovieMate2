...
const languages: string[] = [
  'Telugu', 'English', 'Hindi', 'Tamil', 'Malayalam', 'Kannada', 'Bengali', 
  'Marathi', 'Gujarati', 'Punjabi', 'Spanish', 'French'
];
...
export default function OnboardingScreen() {
  ...
  const { setName: setProfileName, setAge: setProfileAge, setGender: setProfileGender, setLanguage: setProfileLanguage, hydrate, darkMode } = useProfileStore();
